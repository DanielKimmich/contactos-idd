...
@else
	<a href="javascript:void(0)" onclick="deleteEntry(this)" data-route="{{ url($crud->route.'/'.$entry->getKey()) }}" class="btn btn-sm btn-link" data-button-type="delete" data-toggle="tooltip" data-placement="bottom" title="{{ trans('backpack::crud.delete') }}"><i class="la la-trash"></i> </a>
@endif	
@endif
