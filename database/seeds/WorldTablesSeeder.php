...
class WorldTablesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (DB::connection() instanceof SQLiteConnection) {
            ...
            Schema::disableForeignKeyConstraints();
            DB::statement('ALTER SEQUENCE world_continents_id_seq RESTART WITH 8;');
            DB::statement('ALTER SEQUENCE world_continents_locale_id_seq RESTART WITH 15;');
            DB::statement('ALTER SEQUENCE world_countries_id_seq RESTART WITH 249;');
            DB::statement('ALTER SEQUENCE world_countries_locale_id_seq RESTART WITH 495;');
            DB::statement('ALTER SEQUENCE world_divisions_id_seq RESTART WITH 123;');
            DB::statement('ALTER SEQUENCE world_divisions_locale_id_seq RESTART WITH 243;');
            DB::statement('ALTER SEQUENCE world_cities_id_seq RESTART WITH 3800;');
            DB::statement('ALTER SEQUENCE world_cities_locale_id_seq RESTART WITH 3758;');
        }
    }
