@if ($crud->hasAccess('clone'))
	<a href="javascript:void(0)" onclick="cloneEntry(this)" data-route="{{ url($crud->route.'/'.$entry->getKey().'/clone') }}" class="btn btn-sm btn-link" data-button-type="clone" data-toggle="tooltip" data-placement="bottom" title="{{ trans('backpack::crud.clone') }}"><i class="fa fa-clone"></i> </a> 
@endif
