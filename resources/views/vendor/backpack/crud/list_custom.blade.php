...
{{-- Se quita esta clae  "nowrap" para ver en varias lineas--}}
        <table id="crudTable" class="bg-white table table-striped table-hover rounded shadow-xs border-xs" cellspacing="0">          
{{--         <table id="crudTable" class="box table table-striped table-hover display responsive m-t-0" cellspacing="0">  --}}
            <thead>
              <tr>
                {{-- Table columns --}}
