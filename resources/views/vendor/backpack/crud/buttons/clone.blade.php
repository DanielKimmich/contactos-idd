...
@else
	<a href="javascript:void(0)" onclick="cloneEntry(this)" data-route="{{ url($crud->route.'/'.$entry->getKey().'/clone') }}" class="btn btn-sm btn-link" data-button-type="clone" data-toggle="tooltip" data-placement="bottom" title="{{ trans('backpack::crud.clone') }}"><i class="la la-clone"></i> </a> 
@endif  
@endif
